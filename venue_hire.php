<?php include("/includes/head.php"); ?>
    ...
    <body id="top" class="page--venue-hire">
        <?php include("/includes/header.php"); ?>
        <div class="main-content  grid">
            <div class="page-links  grid__col--33">
                <ul class="page-links__list">
                    <li><a class="page-links__anchor" href="#make_a_booking">Make a Booking</a></li>
                    <li><a class="page-links__anchor" href="#royston_house">Royston House</a></li>
                    <li><a class="page-links__anchor" href="#local_attractions">Local Attractions</a></li>
                </ul>
            </div>
            <div class="grid__col--66">
                <section id="make_a_booking" class="section">
                    <h2 class="section__title">Make a Booking</h2>
                    <a class="section__back-to-top" href="#top"><i class="icon-font  icon-font--up-arrow"></i></a>
                    <p>Rubicon Outdoor Centre is operated by the Department of Education and Early Childhood Development. It is available for short-term hire to groups or individuals seeking a venue for outdoor recreation, environmental education, and relaxation! The Centre can also be hired on a daily basis, providing an ideal setting for meetings and seminars.</p>
                    <p>The Rubicon Campus is located in North-Eastern Victoria approximately 130 kilometres northeast of Melbourne in the Rubicon Valley, at the foot of the Blue Range providing a base for a range of activities. The Centre is situated approximately 18 kilometres - 15 minutes travel by road from both Alexandra and Eildon.</p>
                    <p>Rubicon has varied dormitory style accommodation facilities.</p>
                    <p>&ldquo;Goulburn&rdquo; and &ldquo;Torbreck&rdquo; dormitories each accommodate up to 22 persons with 2 persons per room. 10 rooms have a double bunk bed and the other room has 2 single beds with an ensuite. Each of these dormitories has 4 showers and handbasins and 1 indoor toilet.</p>
                    <p>&ldquo;Pinninger&rdquo; accommodates up to 12 persons with 2 persons per room. 5 rooms have a double bunk bed and the other room has 2 single beds. This dormitory has 2 separate bathrooms with 1 toilet, 1 shower and 2 handbasins in each.</p>
                    <p>Catering for Goulburn, Torbreck & Pinninger dormitories occurs in our newly refurbished commercial kitchen and dining room.</p>
                    <p>Use of Commercial Kitchen Facilities to be negotiated. A Bond may be required.</p>
                    <p>&ldquo;Sugarloaf&rdquo; is self contained with a kitchen which allows for self catering within the dormitory. This dormitory accommodates up to 13 persons. There are 3 rooms which have two double bunks (4 persons) and 1 room with a single bed. This dormitory has one bathroom (disabled access) with a toilet, handbasin and a shower. The second bathroom has a shower and handbasin. There is also a second, separate indoor toilet.</p>
                    ...
                    <h3>Activities (3 hour sessions):</h3>
                    <table class="table">
                        <tr>
                            <td>
                ...
                <section id="local_attractions" class="section">
                    <h2 class="section__title">Local Attractions</h2>
                    <a class="section__back-to-top" href="#top"><i class="icon-font  icon-font--up-arrow"></i></a>
                    <p>Only one and a half hours drive from Melbourne, through lush green valleys and forests of soaring Mountain Ash, Murrindindi is not so much a region as a lifestyle.</p>
                    <p>Towns and villages nestle in a landscape of mountains, forests, lakes and sparkling streams; fertile farmlands supply an abundance of natural produce. It's a place to relax and unwind, indulge in treasured pastimes and seek out new adventures.</p>
